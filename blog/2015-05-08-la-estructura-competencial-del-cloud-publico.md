---
title: "La estructura competencial del Cloud Público"
date: 2015-05-08
---
...
Sirva como documento clave para comprender el alcance y el futuro de los servicios en Cloud el documento publicado en España por [INTECO](http://ictlogy.net/bibliography/reports/contacts.php?idc=1703 "INTECO") (2012): *[Estudio sobre el cloud computing en el sector público en España](http://ictlogy.net/bibliography/reports/projects.php?idp=2183).* Desde su publicación ya han pasado tres años en los que sin duda el cloud ha avanzado en su implantación.
...
Es preciso aclarar que en este blog se entiende como Cloud Público (con mayúscula) a un «Cloud privado» pero de acceso exclusivo para las administraciones públicas, alojado, administrado y mantenido por las administraciones públicas sobre un soporte de comunicaciones similar a la [Red SARA](http://administracionelectronica.gob.es/ctt/redsara#.VUyZAPntlHw) española.
...
- **Edición**: creación y alteración de objetos territoriales (véase la entrada de [Registro Urbano](http://www.arnaizpartners.com/blogarnaizpartners/?p=701) en este mismo blog)
