---
title: "Embedding a urbiThings window in your web"
date: 2019-03-21
---
...
- The selection can have as many maps as desired, but it is recommended that they be five or six at the most. To show many maps it is better to create an account WEB site as explained in the previous post.\
   Ask urbiThings the HTML code of the embedded window indicating the selection of maps to present and the dimensions of the embedded window. urbiThings will copy the code to the clipboard
- Paste that code on our page and you’re done

**STEP 1 – REQUEST AN ACCOUNT**

Enter urbiThings.com and in the menu on the left select the option «Account Registration». With indicating a mail account is enough. Once sent you will receive an account verification email and acceptance of the conditions of service. When the registration request is accepted by urbiThings you will receive a welcome email.
...
![](https://info.urbigis.com/wp-content/uploads/2019/04/abrirsel.png)
...
![](https://info.urbigis.com/wp-content/uploads/2019/04/compartir2.png)
...
![](https://info.urbigis.com/wp-content/uploads/2019/04/pegar.png)
