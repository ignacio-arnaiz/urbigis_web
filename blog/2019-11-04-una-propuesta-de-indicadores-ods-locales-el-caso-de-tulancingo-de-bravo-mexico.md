...
Por otra parte la [Agenda 2030 de España](https://www.agenda2030.gob.es/) señala que: «*El Gobierno de España ha establecido un Plan de Acción para la Implementación de la Agenda 2030 en España como un **proyecto de país**. Considera imprescindible tener en cuenta la labor realizada por parte de las Comunidades Autónomas y las **Entidades Locales**, así como las posibles aportaciones de los organismos de la sociedad civil. Por lo anterior, e**l Sistema de medición y seguimiento de la Agenda 2030 tiene que incorporar las actuaciones e indicadores impulsados por estos actores**.**Dada la capacidad de las Entidades Locales en la obtención de datos territorializados, es necesario establecer una metodología de trabajo que permita la captación y puesta en valor de estos datos en relación con las distintas metas de la Agenda 2030. Para la coordinación de los trabajos, es importante establecer acuerdos con la Federación Española de Municipios* *y Provincias que permitan poner en marcha un proyecto piloto de autoevaluación que ayude a conocer la realidad en la implementación y seguimiento de la Agenda 2030 en los distintos municipios. **En cualquier caso, estos datos tendrán la categoría de datos de información local sin que su agregación lleve a determinar datos nacionales**.*» (las negritas son mías)
...
Si la información espacial correcta y actualizada es vital para poder tomar decisiones y controlar el avance de las políticas de desarrollo, también es preciso introducir además nuevos indicadores específicos para medir la evolución de los objetivos ODS en el nivel local. En esta línea el municipio de [Tulancingo de Bravo](http://www.tulancingo.gob.mx/), la Asociación Mexicana de Municipios Inteligentes y Ciudades Inteligentes ([AMMECI](http://www.ameci-ac.org/)) y el [Instituto Arnaiz](http://www.institutoarnaiz.es/) han colaborado utilizando la plataforma de datos geoespaciales [urbiThings](https://urbithings.com/mx_tulancingodebravo.maps) para crear una Infraestructura de Datos orientada a facilitar el desarrollo de los objetivos ODS en el municipio.
...
![](http://info.urbigis.com/wp-content/uploads/2019/11/tulancingo6-300x154.png)

**A) [Mapa de los asentamientos irregulares (2019)](https://urbithings.com/8ce7ebc3-29f3-4cce-a4ac-70e9736da0b7.ms)**
...
![](http://info.urbigis.com/wp-content/uploads/2019/11/tulancingo0-300x152.png)

**B) [Mapa de áreas urbanas y urbano-rurales sin suministro doméstico de agua limpia (2019)](https://urbithings.com/3adc9215-9077-4d00-8591-60a1288d463d.ms)**
...
![](http://info.urbigis.com/wp-content/uploads/2019/11/tulancingo7-300x181.png)

**C) [Mapa de áreas urbanas y urbano-rurales sin drenaje de aguas residuales domésticas (2019)](https://urbithings.com/efa883fc-8874-4e70-9623-d676099f86d0.ms)**
...
![](http://info.urbigis.com/wp-content/uploads/2019/11/tulancingo3-300x151.png)

**D) [Mapa de los equipamientos de salud  (2019)](https://urbithings.com/834bccc8-47ae-47d6-b520-4d612690db00.ms)**
...
![](http://info.urbigis.com/wp-content/uploads/2019/11/tulancingo4-300x153.png)

**E) [Mapa de los equipamientos de educación  (2019)](https://urbithings.com/1119ef46-77d8-4640-b340-912462e6a1fc.ms)**
...
![](http://info.urbigis.com/wp-content/uploads/2019/11/tulancingo5-300x152.png)
...
La utilización de plataformas geoespaciales como [urbiThings](https://urbithings.com), que ya está proporcionando a todos los municipios de Colombia, México, Brasil, España y República Dominicana una IDE local gratuita y usable, es un medio imprescindible para que los gobiernos nacionales empiecen a tomar en consideración la posibilidad de que los municipios sean fuentes fiables de nuevos indicadores ODS locales, más apegados a la realidad de su gestión territorial diaria.

[Ignacio Arnaiz Eguren](https://www.linkedin.com/in/ignacioarnaiz/)
