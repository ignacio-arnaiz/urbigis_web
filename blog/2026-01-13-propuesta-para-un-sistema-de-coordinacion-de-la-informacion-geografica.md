...
Actualmente la Comunidad de Madrid ya dispone de una [Infraestructura de Datos Espaciales](https://idem.comunidad.madrid/catalogocartografia/srv/spa/catalog.search#/home) que ofrece más de 1300 conjuntos de datos y servicios web ordenados por temas y tipo de recursos, según un modelo estándar.
...
Por ahora, salvo lo planteado por plataformas como [urbiGIS](http://www.urbigis.com/), no existen muchos ejemplos de Colaboración reglada por diversas razones:
...
En la entrada del blog de Ministerio para la Transformación Digital y de la Función Pública titulada “[Interoperabilidad de los datos geoespaciales en tiempo real: cómo los estándares OGC permiten intercambiar datos en tiempo real de sensores urbanos, movilidad o clima](https://datos.gob.es/es/blog/interoperabilidad-de-los-datos-geoespaciales-en-tiempo-real-como-los-estandares-ogc-permiten)” aparte de recomendaciones fundamentales como *incorporar la dimensión temporal* o *fomentar un ecosistema de reutilización basado en flujos continuos de datos interoperables*, propone ***un marco de interoperabilidad*** *que normalice la descripción de los fenómenos observados, la estructura de las series temporales y las interfaces de acceso en un ambiente de heterogeneidad tecnológic*a.
