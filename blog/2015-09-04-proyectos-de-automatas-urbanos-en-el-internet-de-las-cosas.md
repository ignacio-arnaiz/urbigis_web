---
title: "El proyecto de edificación: ¿Un Autómata urbano virtual en el Internet de las Cosas?"
date: 2015-09-04
---
...
![](https://info.urbigis.com/wp-content/uploads/2015/09/24.jpg)[![](http://www.arnaizpartners.com/blogarnaizpartners/wp-content/uploads/2015/09/imagen1.jpg)](http://www.arnaizpartners.com/blogarnaizpartners/wp-content/uploads/2015/09/imagen1.jpg)

Algunas de las herramientas CAE más utilizadas son [ANSYS](https://es.wikipedia.org/wiki/ANSYS), [Abacus](https://es.wikipedia.org/wiki/Abaqus), [Patran](https://es.wikipedia.org/wiki/Patran), [SolidWorks](http://www.solidworks.com/), [NX](https://en.wikipedia.org/wiki/Siemens_NX), [Catia](https://en.wikipedia.org/wiki/CATIA) y [Nastran](https://en.wikipedia.org/wiki/Nastran).
...
**1) Tecnología CAD**: que desde los años 80 del siglo pasado eliminó el dibujo manual mediante muy diversas herramientas. Actualmente el sistema preponderante es [AutoCad](https://es.wikipedia.org/wiki/AutoCAD). Esta tecnología ha trasladado la técnica de delineación tradicional al mundo de CAD prácticamente sin alteración.

[![](https://info.urbigis.com/wp-content/uploads/2015/09/25.jpg)![](http://www.arnaizpartners.com/blogarnaizpartners/wp-content/uploads/2015/09/imagen11.jpg)](http://www.arnaizpartners.com/blogarnaizpartners/wp-content/uploads/2015/09/imagen11.jpg)

```
Imagen extraída de https://grabcad.com/library/4-bed-room-house-design
```

**2) Tecnología 3D**: para la realización de simulación fotorealística de los proyectos realizados en CAD, permiten construir escenarios virtuales con recorridos. La herramienta más representativa es [Autodesk 3Ds Max](https://es.wikipedia.org/wiki/Autodesk_3ds_Max).

[![](https://info.urbigis.com/wp-content/uploads/2015/09/26.jpg)![](http://www.arnaizpartners.com/blogarnaizpartners/wp-content/uploads/2015/09/20101026fig1.jpg)](http://www.arnaizpartners.com/blogarnaizpartners/wp-content/uploads/2015/09/20101026fig1.jpg)

```
Imagen extraída de http://www.deskeng.com/virtual_desktop
```

**3) Tecnología [BIM](https://es.wikipedia.org/wiki/Modelado_de_informaci%C3%B3n_de_construcci%C3%B3n)**: aporta al mundo del diseño arquitectónico la orientación a objetos, facilitando el diseño, mejorando el control de componentes e integrando el mundo 2D-3D de forma eficiente. También existen herramientas BIM desde los años 80, pero sus dificultades de uso y su diseño conceptual, tan alejado del mundo de la delineación tradicional, dificultó su despliegue. Sin embargo  ahora ya están sustituyendo al mundo CAD, porque se han abaratado, los ordenadores tienen mucha más capacidad para manejar proyectos complejos y porque nuevas generaciones de delineantes están adquiriendo nuevas destrezas o están siendo sustituidos por los arquitectos que entienden mejor el edificio como un conjunto de objetos.

[![](https://info.urbigis.com/wp-content/uploads/2015/09/27.jpg)![](http://www.arnaizpartners.com/blogarnaizpartners/wp-content/uploads/2015/09/RyderArchitecture05.jpg)](http://www.arnaizpartners.com/blogarnaizpartners/wp-content/uploads/2015/09/RyderArchitecture05.jpg)

```
Imagen extraída de Ryder Arquitectura
```

En este momento la herramienta BIM más representativa es [Revit](https://es.wikipedia.org/wiki/Revit). Constituye un avance significativo para el diseño cuando se utilizan elementos constructivos estandarizados, aunque puede suponer un lastre importante cuando es preciso diseñar objetos *ad hoc* en edificios singulares.
...
Con BIM el diseñador define los elementos estructurales, los objetos y sus propiedades, le sirve para crear los planos de obra y para presupuestar. A partir de esos datos suele utilizar herramientas 3D para construir escenarios fotorealísticos y generar recorridos, bien con sistemas como 3D Studio Max o bien usando  los motores gráficos usados tradicionalmente para crear juegos y escenarios en 3D. En los últimos años se han desarrollado una gran variedad de motores, son muy populares [Source](https://es.wikipedia.org/wiki/Source), [Unity](https://es.wikipedia.org/wiki/Unity_(software)), [Unreal](https://es.wikipedia.org/wiki/Unreal_Engine) o [CryEngine](https://es.wikipedia.org/wiki/CryEngine). Incluso hay aplicaciones que actúan de puente como [Unity@Revit](http://amcbridge.com/labs/desktop-apps/unity-revit) que permite exportar directamente proyectos Revit a Unity.
...
[![](https://info.urbigis.com/wp-content/uploads/2015/09/28.jpg)![](http://www.arnaizpartners.com/blogarnaizpartners/wp-content/uploads/2015/09/iot.jpg)](http://www.arnaizpartners.com/blogarnaizpartners/wp-content/uploads/2015/09/iot.jpg)
...
[![](https://info.urbigis.com/wp-content/uploads/2015/09/29.jpg)![](http://www.arnaizpartners.com/blogarnaizpartners/wp-content/uploads/2015/09/images.jpg)](http://www.arnaizpartners.com/blogarnaizpartners/wp-content/uploads/2015/09/images.jpg)
