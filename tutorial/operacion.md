...
**Restricciones: s**i los Atributos aportados apuntan a Atributos con carácter funcional de “Unidad”, “Referencia” , “Régimen” que no existan previamente en el Inventario y no se hayan aportado explícitamente, éstos también se aportarán como Atributos “hijos” del aportado, de forma que el Inventario mantenga la integridad referencial entre sus Atributos. El Atributo Operador debe contener los datos mínimos, en caso contrario será rechazada la transacción.
...
**Restricciones: l**a Sustitución nunca puede afectar al Carácter Funcional del Atributo.
...
**Restricciones: l**a Operación nunca puede afectar al Grupo de Entidad.
...
**Posición**: posición en la que debe quedar la nueva Relación entre sus Relaciones “hermanas”. Supone una renumeración de las ya existentes. Si no se indica pasará a ser la última.
...
\*\*Restricciones: \*\*la Operación nunca puede afectar al Grupo de Relación ni al os elementos afectados por la Relación.
...
**Relación Operada:** identificador de la Relación a eliminar en el Inventario.
...
Las Operaciones son ejecutadas por el motor transaccional de [urbiGIS](http://urbiGIS.com/) en dos entornos:
...
**Entorno real**. En este entorno el operador de [urbiGIS](http://urbiGIS.com/) efectúa las operaciones contra el Inventario operado en modo real. De forma que cuando aprueba el resultado las modificaciones serán inmediatamente visibles en la publicación por Internet de [urbiGIS](http://urbiGIS.com/). La ejecución de las operaciones en este entorno real se puede retrotraer en todo momento siempre y cuando se efectúe una vuelta atrás ordenada y completa que asegure el mantenimiento de la consistencia de los datos del Inventario. Estas operaciones de vuelta atrás pueden quedar consignadas en el historial de cada elemento. La permanencia en [urbiGIS](http://urbiGIS.com/) de todos los Instrumentos y sus operaciones asegura que en todo momento es posible la reconstrucción de los Inventarios partiendo desde su posición inicial.

Las Operaciones siempre se ejecutan en el entorno competencial de cada [Ámbito](javascript:htLoadSlug('ambito')) por tanto no hay posibilidad de que operaciones ejecutadas en un Ambito afecten a Inventarios de otros Ámbitos.