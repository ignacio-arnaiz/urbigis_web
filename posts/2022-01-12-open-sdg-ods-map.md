---
title: "Open SDG/ODS Map"
date: "2022-01-12"
excerpt: "Qué es Open SDG/ODS Map (OSDGM) En la inmensa mayoría de los municipios del mundo no es posible crear y obtener información espacial por la inexistencia de medios técnicos o humanos. Sin embargo, la c"
---
...
[**OSDGM**](https://urbigis.com/opensdg.maps) se propone como un sistema colaborativo y abierto, sobre la plataforma de [**urbiGIS**](https://urbigis.com), para identificar, delimitar y medir los espacios donde las condiciones de vida y desarrollo de sus habitantes deben ser objeto de mejora.

[**OSDGM**](https://urbigis.com/opensdg.maps) es un sistema dinámico, sus delimitaciones o “entidades” tienen nombre y fecha y no se hacen una vez, sino que se hacen tantas veces como sea necesario para evaluar su mejora temporal.

Cuando un colaborador de [**OSDGM**](https://urbigis.com/opensdg.maps) aporta una entidad al sistema, es preciso que la identifique, date y anote la deficiencia observada. Él mismo o cualquier otro colaborador si observa cambios sustanciales de incremento o decremento de ese espacio aportará una nueva versión anotando su nueva delimitación y fecha. De esa forma todo espacio en [**OSDGM**](https://urbigis.com/opensdg.maps) tendrá tantas versiones como cambios significativos se hayan observado a lo largo del tiempo.

Las alteraciones en el tiempo de las entidades marcarán la tendencia hacia el cumplimiento de las metas SGD.

Cada una de las entidades además se debe asignar a alguno de los territorios administrativos definidos de forma global en [**urbiGIS**](https://urbigis.com), de forma que sea posible el análisis tendencial por unidad administrativa simple o agrupada, siguiendo la escala jerárquica administrativa.

 

Cómo colaborar con Open SDG/ODS

Cualquier persona individual o un colectivo pueden colaborar con [**OSDGM**](https://urbigis.com/opensdg.maps), no existe ninguna restricción ni limitación salvo la verificación por el administrador de [**OSDGM**](https://urbigis.com/opensdg.maps) de la calidad e idoneidad de la información aportada.

Para colaborar es preciso ser usuario de [**urbiGIS**](https://urbigis.com) rellenando la solicitud de registro en [http://urbigis.com/opensdg.maps](http://urbigis.com/opensdg.maps).
...
[**urbiGIS**](https://urbigis.com) proporciona un entorno de trabajo colaborativo basado en los siguientes componentes:
...
Para la delimitación de los espacios los colaboradores podrán utilizar todos los servicios de mapas y datos disponibles en [**urbiGIS**](https://urbigis.com). Incluidos los que resulten del proyecto ODS-Municipal actual en curso por parte del Instituto Arnaiz en muchos municipios de Sudamérica.

Para una explicación más detallada del modo de operación véase el documento de “**[Manual de Operación del colaborador de Open SDG/ODS Map](https://urbigis.com/services/documents/download/5b45bfff-8240-4653-b30e-0d59053791d8/68c3011c-9a4d-4596-8722-285a9cc7e6dd)**” o el «**[Manual de paso a paso de SDG/ODS Map](https://urbigis.com/services/documents/download/5b45bfff-8240-4653-b30e-0d59053791d8/7754d9cf-884d-41b5-baf6-7d5626988fd8)**«

 

**Tipos de entidades en [OSDGM](https://urbigis.com/opensdg.maps)**
