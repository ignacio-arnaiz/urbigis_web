---
title: "El geoportal municipal en urbiGIS: el caso de la Comunidad de Madrid"
date: "2025-01-16"
excerpt: "Salvo las grandes ciudades, como Madrid capital y pocos más, los municipios españoles no disponen de un geoportal propio. Los de la Comunidad de Madrid tampoco escapan de esta carencia, incluso los de"
---
...
Aprovechando que en[ UrbiGIS](https://urbigis.com/) tenemos un geoportal específico a disposición de todos los ayuntamientos de España y de muchos países sudamericanos, (su dirección de internet esta compuesta por «https://urbigis.com/» + <el nombre del municipio sin espacios, ni acentos> + «.maps) hemos configurado una selección, no exhaustiva, de los datos que consideramos de utilidad para el ciudadano en algunos municipios de la Comunidad de Madrid (se puede amplir a todos).
...
Os pongo un geoportal de ejemplo configurado para Villaviciosa de Odón:  [https://urbigis.com/villaviciosadeodon.maps](https://urbigis.com/villaviciosadeodon,maps)
