---
title: "Nuevos Indicadores ODS locales como resultado de la gestión territorial"
date: "2019-11-29"
excerpt: "En el post anterior comentaba la propuesta de Indicadores ODS que hemos realizado para Tulancingo de Bravo (México), apoyando la tesis de que sus datos deben proceder de los procesos de gestión territ"
---
...
En segundo lugar y dejando aparte los importantes problemas interpretativos, he realizado el desglose de algunos de los indicadores más evidentes, normalmente siguiendo el criterio de los ya realizados por algunos organismos estadísticos nacionales. Como resultado he obtenido un total de 284 indicadores. Si se realizase un desglose completo de todos los indicadores compuestos (en el hipotético caso de que alguien se atreva de hacerlo) es probable que esa cifra sufra un notable incremento. Si se tiene interés en comprobarlos he adjuntado a este post una hoja de cálculo con todos ellos: [Comparativo de Indicadores ODS](http://info.urbigis.com/wp-content/uploads/2019/11/Comparativo-de-Indicadores-para-publicar.xlsx).

En tercer lugar he explorado algunos sitios web, ya que la mayoría de los países que han emitido un informe voluntario tienen  un sitio web específico para los ODS donde se presentan los datos y documentos que explican su interés y resultados. Aparte de la propia [Agenda 2030](https://www.un.org/sustainabledevelopment/es/) he explorado [UNSTATS](https://unstats.un.org/sdgs/) (organo estadístico de la ONU), [EUROSTAT](https://ec.europa.eu/eurostat/web/sdi/indicators) (órgano estadístico de la UE), el[ INE](https://www.ine.es/) de España, la [FEMP](http://www.femp.es/) (Federación de Municipios de España), el [gobierno de Aragón](https://www.aragon.es/documents/20127/186069/Estrategia-aragonesa-de-desarrollo-sostenible.pdf/3bc5f7e7-4f15-bdbd-8d33-9c695521f4b4?t=1550747940485) (una comunidad de España), el [gobierno de la ciudad de Madrid](https://www.madrid.es/portales/munimadrid/es/Inicio/El-Ayuntamiento/Accion-Internacional-y-Ciudadania-Global/Noticias/Ciudades-inclusivas-y-de-paz-en-el-marco-de-la-localizacion-de-los-Objetivos-de-Desarrollo-Sostenible-ODS-/?vgnextfmt=default&vgnextoid=83d9112128f4a610VgnVCM1000001d4a900aRCRD&vgnextchannel=e4a9a904a4d28610VgnVCM1000001d4a900aRCRD), el órgano ODS de México ([SIODS](http://agenda2030.mx/odsopc.html)), y los órganos ODS de [Ecuador](https://odsterritorioecuador.ec/), [Brasil](https://odsbrasil.gov.br/), [Argentina](https://www.odsargentina.gob.ar/), [Paraguay](http://comisionods.mre.gov.py/), [Chile](https://www.cl.undp.org/content/chile/es/home/sustainable-development-goals.html) y [Colombia](https://www.ods.gov.co/es). No he incluido [Uruguay](http://www.ods.gub.uy/) porque solo propone indicadores para los objetivos 6, 7, 11, 12 y 15. En[ Bolivia](http://www.nu.org.bo/wp-content/uploads/2018/01/ODS-para-Vivir-Bien.pdf) la documentación no alude a los indicadores sino únicamente relaciona los progresos. En[ Panamá](http://www.undp.org/content/undp/es/home/sustainable-development-goals/resources.html) no he encontrado casi ninguna información. En [El Salvador](http://www.odselsalvador.gob.sv/objetivos-de-desarrollo-sostenible/) no hay tampoco documentación específica del país. [Nicaragua](http://www.pndh.gob.ni/) tiene un Plan Nacional de Desarrollo Humano pero su sitio web es inaccesible. En Honduras se ocupa de los ODS el [Centro Nacional de Información del Sector Social](http://ceniss.gob.hn/combosODS/)  pero no aporta información utilizable. [Costa Rica](http://ods.cr/) aporta documentación donde justifica su alineación con los objetivos sin alterar su contenido ni proponer nuevos. [Perú](http://www.pods.pe/)  y [Guatemala](https://onu.org.gt/objetivos-de-desarrollo/) no aportan datos sobre los indicadores. La Comisión ODS de la [República Dominicana](http://ods.gob.do/Indicador) aporta una web donde los indicadores se ajustan completamente a los definidos por la Agenda 2030. No he explorado más países porque la empanada mental y los problemas idiomáticos me lo impiden.
